...
## `qos_client` - [0.8.0](https://github.com/tkhq/qos/compare/qos_client-v0.7.0...qos_client-v0.8.0) - 2026-05-18

### Added
- add qos json manifest v2 and protocol msg
- [**breaking**] add VersionRequest/VersionResponse protocol messages (SYS-43)
- [**breaking**] Support passing env vars to pivot apps

### Fixed
- fix lints
- Add BootStandardJsonEnvelopeRequest to fix slowdown

### Other
- Merge branch 'main' of github.com:tkhq/qos into avi/json-manifest-v2
- Merge branch 'main' of github.com:tkhq/qos into avi/json-manifest-v2
- Address review
- Address review
- Merge pull request #686 from tkhq/avi/move-cargo-root
- move cargo workspace Cargo.toml to root of repo
...
## `qos_test_primitives` - [0.8.0](https://github.com/tkhq/qos/compare/qos_test_primitives-v0.7.0...qos_test_primitives-v0.8.0) - 2026-05-18
...
### Other
- upgrade all crates to Rust edition 2024

## `qos_net` - [0.8.0](https://github.com/tkhq/qos/compare/qos_net-v0.7.0...qos_net-v0.8.0) - 2026-05-18
...
## `qos_core` - [0.8.0](https://github.com/tkhq/qos/compare/qos_core-v0.7.0...qos_core-v0.8.0) - 2026-05-18
...
### Fixed
- fix lints
- remove all usage of serde_json::RawValue It's broken
- Add BootStandardJsonEnvelopeRequest to fix slowdown
- increase socket timeout to account for pivot app bin hex
- [**breaking**] revert breaking env changes to manifest and add more tests

### Other
- cargo fmt
- Merge branch 'main' of github.com:tkhq/qos into avi/json-manifest-v2
- Make ProtocolMsg camelCase again
- cleanup
- Merge branch 'main' of github.com:tkhq/qos into avi/json-manifest-v2
- Address review
- Address review
- Merge pull request #695 from tkhq/richard/pathwrapper-display-impl
- normalize PathWrapper to string
...
## `qos_p256` - [0.8.0](https://github.com/tkhq/qos/compare/qos_p256-v0.7.0...qos_p256-v0.8.0) - 2026-05-18
...
## `qos_nsm` - [0.8.0](https://github.com/tkhq/qos/compare/qos_nsm-v0.7.0...qos_nsm-v0.8.0) - 2026-05-18
...
## `qos_json` - [0.8.0](https://github.com/tkhq/qos/releases/tag/qos_json-v0.8.0) - 2026-05-18
...
## `qos_hex` - [0.8.0](https://github.com/tkhq/qos/compare/qos_hex-v0.7.0...qos_hex-v0.8.0) - 2026-05-18
...
## `qos_crypto` - [0.8.0](https://github.com/tkhq/qos/compare/qos_crypto-v0.7.0...qos_crypto-v0.8.0) - 2026-05-18
