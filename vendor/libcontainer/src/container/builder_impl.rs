...
impl ContainerBuilderImpl {
    ...
    fn run_container(&mut self) -> Result<Pid, LibcontainerError> {
        ...
        let cgroup_config = libcgroups::common::CgroupConfig {
            ...
            // QOS runs as enclave root and creates the cgroup before entering
            // the requested user namespace. Honor the explicitly selected
            // cgroupfs backend; forcing systemd here makes every userns
            // container fail in a systemd-free initramfs.
