...
pub struct ProtocolError {
    ...
    #[prost(message, optional, tag = "3")]
    pub invalid_approval: ::core::option::Option<Approval>,
    /// For P256Error, InvalidP256DRKey, FailedToGetEphemeralKey, FailedToGetQuorumKey
    #[prost(string, optional, tag = "4")]
    pub p256_error: ::core::option::Option<::prost::alloc::string::String>,
    /// For NoMatchingRoute, InvalidStateTransition
    #[prost(enumeration = "ProtocolPhase", optional, tag = "5")]
    pub phase: ::core::option::Option<i32>,
    #[prost(enumeration = "ProtocolPhase", optional, tag = "6")]
    pub expected_phase: ::core::option::Option<i32>,
}
