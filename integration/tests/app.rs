...
async fn sample_app_e2e() {
	...
	let app_usock: PathWrapper = "/tmp/sample_app_e2e/app_sock.sock".into();
	let quorum_path: PathWrapper = "/tmp/sample_app_e2e/quorum.secret".into();
	let pivot_path: PathWrapper = "/tmp/sample_app_e2e/pivot.pivot".into();
	let manifest_path: PathWrapper =
		"/tmp/sample_app-e2e/manifest.manifest".into();
	let eph_path: PathWrapper = "/tmp/sample_app_e2e/eph.secret".into();
