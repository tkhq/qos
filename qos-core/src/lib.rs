...
#[cfg(not(feature = "vm"))]
pub const QUORUM_FILE: &str = "./local.qos.quorum.key";
/// Path to Quorum Key secret.
#[cfg(feature = "vm")]
...
#[cfg(not(feature = "vm"))]
pub const PIVOT_FILE: &str = "./local.qos.pivot.bin";
/// Path to Pivot binary.
#[cfg(feature = "vm")]
...
#[cfg(not(feature = "vm"))]
pub const EPHEMERAL_KEY_FILE: &str = "./local.qos.ephemeral.key";
/// Path to Ephemeral Key.
#[cfg(feature = "vm")]
...
#[cfg(not(feature = "vm"))]
pub const MANIFEST_FILE: &str = "./local.qos.manifest";
/// Path to the Manifest.
#[cfg(feature = "vm")]
...
#[cfg(not(feature = "vm"))]
pub const SEC_APP_SOCK: &str = "./local.sec_app.sock";
/// Default socket for enclave <-> secure app communication.
#[cfg(feature = "vm")]
