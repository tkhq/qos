...
# Comment in for fast local docker builds
...
# # Build application
# COPY . .
# RUN cargo build --release --bin qos-core --features vm --no-default-features
# # RUN cargo build --release --bin qos-core --features vm
